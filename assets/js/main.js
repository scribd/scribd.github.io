...
// Open an accordion panel if anchor hash matches panel heading id
var hash = window.location.toString().split('#')[1]
var heading = document.querySelector(".accordion__heading#" + CSS.escape(hash));

if (heading) {
    heading.querySelector('.accordion__trigger').click();
}
